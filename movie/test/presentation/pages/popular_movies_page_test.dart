...
void main() {
  ...
  testWidgets('Page should display AppBar, ListView, and popular page when data is loaded',
      (WidgetTester tester) async {
    when(() => fakePopularMoviesBloc.state).thenReturn(PopularMoviesHasData(testMovieList));
  ...
  testWidgets('Page should display text with message when Error', (WidgetTester tester) async {
    ...
    when(() => fakePopularMoviesBloc.state).thenReturn(PopularMoviesError(errorMessage));
