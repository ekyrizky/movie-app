...
void main() {
  ...
  testWidgets('Page should display center progress bar when loading', (WidgetTester tester) async {
    when(() => fakeTopRatedMoviesBloc.state).thenReturn(TopRatedMoviesLoading());
  ...
  testWidgets('Page should display AppBar when data is loaded', (WidgetTester tester) async {
    when(() => fakeTopRatedMoviesBloc.state).thenReturn(TopRatedMoviesHasData(testMovieList));
  ...
  testWidgets('Page should display text with message when Error', (WidgetTester tester) async {
    ...
    when(() => fakeTopRatedMoviesBloc.state).thenReturn(TopRatedMoviesError(errorMessage));
